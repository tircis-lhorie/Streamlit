...
st.sidebar.markdown("<p style='color: white;'> **TIRCIS** est une spin-off de l'Université de Namur spécialisée en **Business Intelligence** augmentée. Notre solution permet de **cartographier les liens de causalité entre les KPIs** d’une organisation afin d’anticiper les effets de chaque décision. Contact: tircis@unamur.be</p>", unsafe_allow_html=True)
