...
fact_links = fact_links[fact_links["weight"] > 0]  # simplification initiale

# --- Options utilisateur ---
st.title("🧠 Visualisation des causalités entre KPIs")
col1, col2, col3, col4 = st.columns(4)

bsc_view = col1.checkbox("Vue BSC", value=True)
signs_on = col2.checkbox("Afficher les signes", value=True)
sust_on = col3.checkbox("Colorer selon durabilité", value=True)
weights_on = col4.checkbox("Épaisseur selon poids", value=True)
